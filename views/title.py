...
class TabsTitle(QWidget):
    def __init__(self, mainform):
        ...
        self.tab_config = QToolButton(self.tabsgroup)
        self.tab_config.setStyleSheet("background-color: rgba(0, 0, 0, 0)")
        self.tab_config.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        self.tab_config.setIcon(QIcon("images/config.png"))
        self.tab_config.setIconSize(QSize(48, 48))
        self.tab_config.setFixedSize(QSize(70, 70))
        self.tab_config.setText("Config")
        ...
        self.tab_register = QToolButton(self.tabsgroup)
        self.tab_register.setStyleSheet("background-color: rgba(0, 0, 0, 0)")
        self.tab_register.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        self.tab_register.setIcon(QIcon("images/register.png"))
        self.tab_register.setIconSize(QSize(48, 48))
        self.tab_register.setFixedSize(QSize(70, 70))
        self.tab_register.setText("REGISTER")
        tabs_layout.addWidget(self.tab_config)
