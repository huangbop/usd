...
#
# Created: Tue Feb 10 22:39:50 2015
...
class Ui_title(object):
    def setupUi(self, title):
        ...
        self.tab_config = QtGui.QToolButton(self.bg)
        self.tab_config.setMinimumSize(QtCore.QSize(70, 70))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/images/config.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tab_config.setIcon(icon)
        self.tab_config.setIconSize(QtCore.QSize(48, 48))
        self.tab_config.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.tab_config.setObjectName(_fromUtf8("tab_config"))
        self.horizontalLayout_2.addWidget(self.tab_config)
        self.tab_uart = QtGui.QToolButton(self.bg)
        self.tab_uart.setMinimumSize(QtCore.QSize(70, 70))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/images/uart.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tab_uart.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/images/gpio.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tab_gpio.setIcon(icon2)
        ...
        self.tab_register = QtGui.QToolButton(self.bg)
        self.tab_register.setMinimumSize(QtCore.QSize(70, 70))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/images/register.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tab_register.setIcon(icon3)
        self.tab_register.setIconSize(QtCore.QSize(48, 48))
        self.tab_register.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.tab_register.setObjectName(_fromUtf8("tab_register"))
        self.horizontalLayout_2.addWidget(self.tab_register)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/images/setting.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/images/min.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/images/close.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, title):
        ...
        self.tab_config.setText(_translate("title", "CONFIG", None))
        self.tab_uart.setText(_translate("title", "UART", None))
        self.tab_gpio.setText(_translate("title", "GPIO", None))
        self.tab_register.setText(_translate("title", "REGISTER", None))
